...
#define TEXTWRITER_TEXTS_H
    ...
    #define W0001 "TextWriter V1.1.2, Copyright (C) 2022-2023 NULL_703, All rights reserved.\n"\
        ...
        "[-H] [--export-as-hex]: Dump file as \'.hex\' file.\n"\
        "[-d] [--dehex]: Restore \'.hex\' file as original file.\n"
    ...
    #define W0031 "Warning: Bufsize of value not equal 0, line-number is not show. [W_1003]\n"
    #define W0032 "Warning: The total number of HEX sequences is not an even number, and the last item will be discarded. [W_2005]\n"\
        "\033[0;36mNote: This is usually not the case with HEX files generated by this program, "\
        "which mean that the file may not be automatically generated or the file may have been tampered with, and parts of the output file may be unreadable.\033[m\n"
    #define W0033 "Info: Copying original file of data to tempfile. [I_2002]\n"
    #define W0034 "Warning: Skipped non POSIX not support of function.[W_3001]\n"
#endif    // ZH_CN
